...
mod tests {
    ...
    fn test_create_valid_input() {
        ...
        assert_eq!(
            command.optional_args.get(SAVE_DIR_OPTIONAL_ARGUMENT),
    ...
    fn test_create_with_missing_arguments() {
        ...
        assert_eq!(
            result.unwrap_err(),
            "Invalid number of arguments for delete-player."
        );
    }
